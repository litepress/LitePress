...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	...
	function wp_install_defaults( $user_id ) {
		...
		$first_comment_email  = ! empty( $first_comment_email ) ? $first_comment_email : 'i@litepress.cn';
		$first_comment_url    = ! empty( $first_comment_url ) ? $first_comment_url : 'https://litepress.cn/';
