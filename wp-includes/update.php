 ...
 *
 * Checks against the WordPress server at api.litepress.cn. Will only check
...
function wp_version_check( $extra_stats = array(), $force_check = false ) {
	...
	$url      = 'http://api.litepress.cn/core/version-check/1.7/?' . http_build_query( $query, null, '&' );
	$http_url = $url;
...
function wp_update_plugins( $extra_stats = array() ) {
	...
	$url      = 'http://api.litepress.cn/plugins/update-check/1.1/';
	$http_url = $url;
	$ssl      = wp_http_supports( array( 'ssl' ) );
...
function wp_update_themes( $extra_stats = array() ) {
	...
	$url      = 'http://api.litepress.cn/themes/update-check/1.1/';
	$http_url = $url;
	$ssl      = wp_http_supports( array( 'ssl' ) );
