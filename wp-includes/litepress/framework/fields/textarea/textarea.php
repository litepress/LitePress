...
if ( ! class_exists( CSF_Field_textarea::class ) ) {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        foreach ( $instances as $instance_key ) {
          ...
          if ( isset( Framework::$shortcode_instances[$instance_key] ) ) {

            $button_title = Framework::$shortcode_instances[$instance_key]['button_title'];
