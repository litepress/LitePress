...
if ( ! class_exists( WP_Customize_Panel_Framework::class ) && class_exists( WP_Customize_Panel::class ) ) {
 ...
 *
 */
if ( ! class_exists( WP_Customize_Section_Framework::class ) && class_exists( WP_Customize_Section::class ) ) {
 ...
 *
 */
if ( ! class_exists( WP_Customize_Control_Framework::class ) && class_exists( WP_Customize_Control::class ) ) {
  class WP_Customize_Control_CSF extends WP_Customize_Control {
    ...
    public function render_field_content() {
      ...
      Framework::field( $this->field, $this->value(), $this->unique, 'customize' );
